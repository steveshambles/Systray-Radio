...
To record the audio streams read my article:
...
def visit_blog(stray):
    ...
    webbrowser.open('https://stevepython.wordpress.com/2020/03/22/systray-radio-python-app')
...
def sr_about(stray):
    ...
    ctypes.windll.user32.MessageBoxW(None,
                                     ...
                                     'The stations included are just my favourites.\n\n'
                                     'Over time the radio streams may need updating\n'
                                     'to keep them working.',
                                     u'Systray Radio V0.14', 0)
...
def lbc_news(stray):
    """LBC stream."""
    webbrowser.open_new('https://media-ssl.musicradio.com/LBCNewsUK')
...
hover_text = 'Systray Radio V0.14 April 2020'
...
menu_options = (('BBC Radio 4', r'icons/r4.ico', radio_4),
                ...
                ('LBC 24 News', r'icons/lbc.ico', lbc_news),
